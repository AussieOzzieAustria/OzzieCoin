...
public:
    explicit AmountSpinBox(QWidget *parent):
        ...
        currentUnit(BitcoinUnits::OZC),
        singleStep(100) // satoshis
    {
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::OZC, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
